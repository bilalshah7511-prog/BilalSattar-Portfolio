...
I've contributed to healthcare and education platforms, built marketing landings and data-heavy dashboards, and I'm always leveling up on patterns that scale with the team.`,
  email: process.env.NEXT_PUBLIC_CONTACT_EMAIL ?? "bilalshah7511@gmail.com",
...
export const experience: readonly ExperienceItem[] = [
  {
    ...
    period: "2024 — Present",
    bullets: [
      "Shipped FAD Next (https://foralldoctors.com) with Next.js and responsive, accessible UI.",
